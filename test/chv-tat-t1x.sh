...
# Supposed to be invoked by "./qa chv-tat-t1x"
...
TRANSFER_FILE="apertium-chv-tat.chv-tat.t1x"
TRANSFER_MODE="apertium-transfer -b apertium-chv-tat.chv-tat.t1x chv-tat.t1x.bin"
