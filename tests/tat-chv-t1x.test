...
# Supposed to be invoked by "./qa tat-chv-t1x"
...
TRANSFER_FILE="apertium-chv-tat.tat-chv.t1x"
TRANSFER_MODE="apertium-transfer -b apertium-chv-tat.tat-chv.t1x tat-chv.t1x.bin"
